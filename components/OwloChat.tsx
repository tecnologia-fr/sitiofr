          ...
          {open && (
            ...
            >
              <div className="bg-white shadow-xl rounded-lg overflow-hidden border">
                ...
                <div className={"bg-gray-50"} style={{ height: minimized ? 56 : 620 }}>
                  {minimized ? (
                    <div className="p-4 text-sm text-gray-600">Minimizado — haz clic en el icono para abrir</div>
                  ) : (
                    <div className="h-full w-full">
                      <iframe
                        title={title?? "Owlo Chat"}
                        src={`http://www.drakorian.ai:3000/web/chat?partnerId=${partnerId}&spaceId=${spaceId}`}

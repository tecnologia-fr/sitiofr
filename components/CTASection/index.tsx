  ...
  return (
    <section
      ...
      className={`relative py-8 px-4 flex flex-col lg:flex-row ${
        props.isHero
          ? "justify-start lg:justify-center pt-20"
          : "min-h-[44rem] justify-center"
    ...
    >
      ...
      >
        ...
        <div
          className={`${props.isHero ? "lg:w-4/6" : "lg:w-1/2"} text-${
            props.textColor
          } z-10`}
        >
          <RenderIf condition={props.title && props.isHero}>
            <h1
              className={`text-7xl  lg:text-8xl text-center lg:text-left mb-6 font-light`}
            >
              {textHighlighter(props.title || "")}
            </h1>
          </RenderIf>
          <RenderIf condition={props.title && !props.isHero}>
            <h2 className={`text-4xl font-light lg:text-5xl mb-6`}>
              {textHighlighter(props.title || "")}
            </h2>
          </RenderIf>
          <div

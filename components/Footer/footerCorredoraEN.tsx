...
const FooterCorredoraEN: React.FC = () => {
  return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm">call us: +56 2 2482 1500 </p>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm">call us: +56 55 2466 220</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm">call us: +56 41 3800 080</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-white lg:flex-shrink-0">
            <div className="text-left">
              ...
              <button className="bg-destacado text-white px-4 py-2 rounded-md mr-8 mb-8">
                <a href="/en/insurance-brokerage/contact">Contact us</a>
              </button>
              <br></br>
              {/* LinkedIn Logo */}
...
export default FooterCorredoraEN;
